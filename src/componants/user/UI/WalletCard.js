...
const WalletCard = ({bal}) => {
  return (
    <div className="walletBalanceCard  fixed top-24 bg-white text-black left-0 right-0 m-2 justify-between">
      <div className="flex space-x-2 " >
        <div className="svgwrapper flex justify-start">
          <svg
            viewBox="0 0 24 26"
            fill="none"
