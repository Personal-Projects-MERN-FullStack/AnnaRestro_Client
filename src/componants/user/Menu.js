  ...
  return (
    <div className="flex flex-col  w-full fixed top-0 right-0 left-0 bottom-0 h-screen">
      <div className="  top-0 left-0 right-0 h-[110px] w-full">
        <div className=" h-full bg-white shadow-sm flex flex-col ">
          <div className="h-3/6 w-full flex">
            ...
            <div className="w-3/6 h-full flex justify-end items-center pr-3">
              Search Logo Here
            </div>
          </div>
      ...
      <div className="h-5/6 flex w-full ">
        ...
        <div className="w-10/12 h-full bg-green-100">
          <div className="h-12 text-2xl font-bold flex justify-start items-center pl-4 ">
          
            BREAKFAST
          </div>
          <div className=" h-full mx-2 mt-2 overflow-auto ">
            <Bcard img="/fitems/dosa.png" name="Dosa" desc="Best Dosa In Sihngahd Campus" price="40"/>
            <Bcard img="/fitems/mdosa.png" name=" MaSala Dosa" desc="Try Our New MaSala Dosa " price="50"/>
            <Bcard img="/fitems/idli.png" name="Idli" desc="Latur Special Idli " price="30"/>
            <Bcard img="/fitems/dosa.png" name="Dosa" desc="Best Dosa In Sihngahd Campus" price="40"/>
            <Bcard img="/fitems/dosa.png" name="Dosa" desc="Best Dosa In Sihngahd Campus" price="40"/>
            <Bcard img="/fitems/dosa.png" name="Dosa" desc="Best Dosa In Sihngahd Campus" price="40"/>
